...
cwd = "C:/Users/Max/source/repos/TensorFlow_UIClassifier/tfrecord_builder/TrainingData_rough/"
#C:/Users/Max/source/repos/TensorFlow_UIClassifier/tfrecord_builder/TrainingData_rough
...
keys = [str(i) for i in list(range(3))]
values = [i for i in list(range(3))]
classes = dict(zip(keys, values))


# name format of the tfrecord files
recordFileName = ("train-%.3d.tfrecords" % recordFileNum)
